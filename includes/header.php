...
<head>
	...
	<!-- Inline CSS for logo styling -->
	<style>
		.navbar-brand img {
			max-height: 40px; /* Adjusts logo height to fit within navbar */
			width: auto; /* Maintains aspect ratio */
			margin-top: -7px; /* Centers vertically in navbar */
		}
	</style>
</head>
<body>
		...
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.php">
					<img src="custom/images/logo.png" alt="Stock Management System Logo">
				</a>
			</div>
